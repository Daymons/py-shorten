...
`baseurl = "https://short.it"`. To run it, you first need to install the requirements with  
`pip install -r requirements.txt`. When this finishes, you can run the server with `python app.py`
